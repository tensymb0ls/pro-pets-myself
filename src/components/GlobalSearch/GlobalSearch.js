  ...
  return (
    <div className="flex items-center flex-initial w-1/2  ">
      ...
      <input
        ...
        className="text-colorTextLightGray text-[12px] font-[400] bg-white pl-[40px] pr-[5px] h-[34px] rounded-[15px] outline-none -ml-[30px] flex-auto"
